...
Factory configuration, copied macros, and recovery snapshots are excluded from
the root MIT grant. Their precise vendor/import revisions remain unresolved.
The MIT license applies only to original bolens-authored maintenance code,
documentation, and configuration contributions that are independently licensable.
